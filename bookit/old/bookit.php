...
$insert_query = "INSERT INTO booking_info (`booking_info_key`, `floor_no`, `booked_on`, `date_to_book`, `from_time`, `to_time`, `booked_by`, `project`) VALUES (NULL, '".$floorNo."', '".date('Y-m-d')."', '".$dateInfo."', '".$fromTime."',  '".$toTime."', '".$username."',  '".$project."');";
//echo $select_users_query;
$result = mysql_query($insert_query) or die('Could not find the user');
echo '

<label>Booking done on '.$dateToBook.' from '.$fromTime.' to '.$toTime.' for '.$floorNo;
